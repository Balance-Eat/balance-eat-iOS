...
final class MockUserUseCase: UserUseCaseProtocol {
    ...
    func createUser(request: UserCreateRequest) async -> Result<Void, NetworkError> { createUserResult }
    func updateUser(userData: UserData) async -> Result<Void, NetworkError> { updateUserResult }
